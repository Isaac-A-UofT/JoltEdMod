...
class CurriculumGenerator:
    ...
    async def generate_curriculum_template(self, topic, identity, target):
        self.template = {
            "blocks": [
                {
                    "type": "SeedBlock",
        ...
        return await self.create_markdown_file(blocks)
    ...
    async def create_markdown_file(self, blocks):
        content = ""
        for block in blocks:
